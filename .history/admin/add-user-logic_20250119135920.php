...
if(isset($_POST['submit'])) {
    ...
    if(!$firstname) {
        ...
        $_SESSION['add'] = "Please enter your lastname";
    } elseif(!$username) {
        $_SESSION['add'] = "Please enter your username";
    } elseif(!$email) {
        $_SESSION['add'] = "Please enter a valid email";
    } elseif(strlen($createpassword) < 8 || strlen($confirmpassword) < 8) {
        $_SESSION['add'] = "Password should be 8+ characters";
    } elseif(!$avatar['name']) {
        $_SESSION['add'] = "Please add avatar";
    } else {
