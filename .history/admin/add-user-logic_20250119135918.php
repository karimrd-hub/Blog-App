...
if(isset($_POST['submit'])) {
    ...
    if(!$firstname) {
        $_SESSION['sign'] = "Please enter your First name";
    } elseif(!$lastname) {
        $_SESSION['sign'] = "Please enter your lastname";
    } elseif(!$username) {
        $_SESSION['sign'] = "Please enter your username";
    } elseif(!$email) {
        $_SESSION['sign'] = "Please enter a valid email";
    } elseif(strlen($createpassword) < 8 || strlen($confirmpassword) < 8) {
        $_SESSION['sign'] = "Password should be 8+ characters";
    } elseif(!$avatar['name']) {
        $_SESSION['sign'] = "Please add avatar";
    } else {
