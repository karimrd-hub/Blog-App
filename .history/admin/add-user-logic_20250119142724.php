...
if(isset($_POST['submit'])) {
    ...
    if(isset($_SESSION['add-user'])) {
        ...
        $insert_user_query = "INSERT INTO users (firstname, lastname, username, email, password, avatar, is_admin) VALUES('$firstname', '$lastname', '$username', '$email', '$hashed_password', '$avatar_name', $is)";
