...
if(isset($_POST['submit'])) {
            ...
            if(mysqli_num_rows($user_check_result) > 0) {
                ...
                if(in_array($extension, $allowed_files)) {
                    ...
                    if($avatar['size'] < 2000000) {
                        ...
                        $_SESSION['add-userf'] = "FILE should be less than 2mb";
                    }    
                } else {
                    $_SESSION['add-userf'] = "FILE should be png, jpg, or jpeg";
                }
            }
        }
    }
    ...
    if(isset($_SESSION['add-userf'])) {
        // pass from data back to signup page
        $_SESSION['add-userf-data'] = $_POST;
